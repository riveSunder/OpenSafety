"""
This environments is modified from hardmaru's [estool](https://github.com/hardmaru/estool/)
OpenSafety uses the code from estool under an MIT license, and maintains the MIT license in this version (as well as the rest of OpenSafety).


In turn, estool is based on a gist by erwincoumans. hardmaru's original attribution is retained below.
